  ...
  const handleSignIn = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (role !== "ADMIN") {
        ...
        throw new Error("Contul nu are permisiune de administrator.");
      }
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f6f8fc] px-4">
      <section className="w-full max-w-md rounded-3xl border border-[#dadce0] bg-white p-8 shadow-sm">
        ...
        <p className="mt-2 text-sm text-[#5f6368]">Autentificare dedicată pentru dashboard-ul de administrator.</p>
